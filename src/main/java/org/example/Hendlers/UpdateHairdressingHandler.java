...
public class UpdateHairdressingHandler implements HttpHandler {
    HairdressingServicesServise service = new HairdressingServicesServiseImpl();

    @Override
    public void handle(HttpExchange exchange) throws IOException {
        try {
            System.out.println("UPHairdressingServices");
            ...
            HairdressingServices hairdressingServices = new HairdressingServices(serviceidInt,serviceName, description, price, duration, category);
            System.out.println(hairdressingServices);
            service.updateHairdressingServices(hairdressingServices);
