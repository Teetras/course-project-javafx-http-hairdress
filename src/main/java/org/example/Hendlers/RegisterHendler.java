...
public class RegisterHendler implements HttpHandler {
...
PersonService person=new PersonServiceImpl();
    ...
    public void handle(HttpExchange exchange) throws IOException {
        try {
            ...
            person.addPerson(new Person(parameters.get("name"), parameters.get("phone")));
//            person.addPerson(new Person(parameters.get("name"), parameters.get("phone"));

            User user=new User( parameters.get("login"), parameters.get("password"),new Person(parameters.get("name"), parameters.get("phone")));
            serve.addUser(user);
